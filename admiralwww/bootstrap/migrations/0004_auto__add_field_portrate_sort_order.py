...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PortRate.sort_order'
        db.add_column('bootstrap_portrate', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PortRate.sort_order'
        db.delete_column('bootstrap_portrate', 'sort_order')
    ...
    models = {
        ...
        'bootstrap.nds': {
            'Meta': {'ordering': "['name']", 'object_name': 'Nds'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
            'value': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'bootstrap.params': {
            'Meta': {'ordering': "['key']", 'object_name': 'Params'},
        ...
        'bootstrap.portrate': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'PortRate'},
        ...
        'bootstrap.portservicie': {
            'Meta': {'ordering': "['name']", 'object_name': 'PortServicie'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
